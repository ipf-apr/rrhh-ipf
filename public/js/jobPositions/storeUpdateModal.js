const createEditJobPositionForm = document.querySelector("#createEditJobPositionForm");
...
const myModal = new bootstrap.Modal(document.querySelector('#modalJobPositionCreate'));
